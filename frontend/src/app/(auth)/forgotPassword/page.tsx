...
const ForgotPasswordPage = () => {
  ...
  const handleSendCode = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${process.env.NEXT_PUBLIC_BACK_API}/forgotPassword`, { 
        email 
      });
  ...
  const handleVerifyCode = async (e) => {
    ...
    try {
      const response = await axios.post(`${process.env.NEXT_PUBLIC_BACK_API}/verifyCode`, { 
        email, 
        code 
      });
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const response = await axios.post(`${process.env.NEXT_PUBLIC_BACK_API}/resetPasswordWithToken`, { 
        resetToken, 
        newPassword 
      });
