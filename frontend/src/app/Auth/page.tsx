...
export default function AuthLayout({ type }: AuthLayoutProps) {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8 bg-transparent flex-col gap-6">
      ...
      <div className='flex flex-col gap-2 sm:gap-3 items-center justify-center text-center'>
        {isSignIn ? (
          ...
          <>
            <h2 className='text-2xl font-bold'>Welcome to the Sign Up Page</h2>
            <p className='text-lg'>Please fill in the details below to create an account.</p>
          </>
        )}
      </div>
        
        <div className='w-full max-w-sm sm:max-w-md lg:max-w-lg gap-4 sm:gap-6 flex flex-col items-center justify-center'>
          <input 
            type="text" 
            name="username"
          ...
          {isSignIn ? (
            <>
              ...
              <div className='flex gap-2 items-start justify-center w-full'>
                <h3 className='text-xs sm:text-sm text-gray-500 hover:text-blue-400 transition-colors duration-300 ease-in-out'>
                  <Link href="/restorepassword">Forgot your password?</Link>
                </h3>
              </div>
              
              <div className='flex gap-2 items-center justify-center'>
                <h3 className='text-xs sm:text-sm text-gray-500'>Don&apos;t have an account?</h3>
                <h3 className='text-xs sm:text-sm hover:text-blue-400 transition-colors duration-300 ease-in-out'> 
            ...
            <>
              <div className='w-full '>
                <button className='w-full p-3 sm:p-4 rounded-2xl border border-transparent bg-gray-500 text-white text-sm sm:text-base font-semibold hover:bg-gray-400 transition-all duration-300 ease-in-out hover:cursor-pointer'>
                  Sign Up
                </button>
              </div>
        ...
        {!isSignIn && (
        <div className="hidden lg:flex lg:w-1/2 h-1/2 lg:h-full items-center justify-center lg:justify-start mb-8 lg:mb-0">
          <FlyingSaucer />
        </div>
      )}
      </div>
