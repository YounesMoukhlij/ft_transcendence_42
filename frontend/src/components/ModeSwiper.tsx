...
export default function ModeSwiper()
{
    ...
    const modes = [
      ...
      { id: 2, title: t('game.gameVsHuman'), description: t('game.playAgainstComputer'), buttonname: t('game.ai'), image: "/robot.png", mode: 'ai' as const },
      ...
      { id: 4, title: t('game.ticTacToe'), description: t('game.playXOGameLocally'), buttonname: t('game.xOGame'), image: "/1v1.png", mode: 'tic-tac-toe' as const },
    ];
