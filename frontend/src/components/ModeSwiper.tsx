...
export default function ModeSwiper()
{
    ...
    const modes = [
      { id: 1, title: t('game.localTournament'), description: t('game.allPlayersSameDevice'), buttonname: t('game.tournament'), image: "/tournament.png", mode: 'tournament' as const },
      ...
      { id: 3, title: t('game.gameVsHuman'), description: t('game.playWithFriend'), buttonname: t('game.1Versus1'), image: "/1v1.png", mode: 'local' as const },
      { id: 4, title: t('game.gameVsHuman'), description: t('game.playAgainstComputer'), buttonname: t('game.ai'), image: "/robot.png", mode: 'ai' as const },
