...
function SignUpForm({ onToggle }) {
    ...
    function SignInForm1({ onToggle }) {
        ...
        const setUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$userStore$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUserStore"])({
            "SignUpForm.SignInForm.useUserStore[setUser]": (state)=>state.setUser
        }["SignUpForm.SignInForm.useUserStore[setUser]"]);
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
            "SignUpForm.SignInForm.useEffect": ()=>{
                ...
                if (userId) {
                    const fetchUserData = {
                        "SignUpForm.SignInForm.useEffect.fetchUserData": async ()=>{
                            try {
                                // REPLACED FETCH WITH AXIOS
                    ...
                    }["SignUpForm.SignInForm.useEffect.fetchUserData"];
                    fetchUserData();
                }
            }
        }["SignUpForm.SignInForm.useEffect"], [
    ...
    _s(SignInForm1, "e6gVxEDp36kTmisMXc4b2SzHWBE=", false, function() {
        return [
...
_s1(SignUpForm, "bSTy+YlSxWKQcIPC4PY+OsRk4lM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=src_38ddbe6a._.js.map