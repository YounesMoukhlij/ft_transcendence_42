...
"[project]/src/app/chat/globalSocket.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$chat$2f$globalSocket$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/chat/globalSocket.tsx [app-client] (ecmascript)");
;
...
function chatPage() {
    ...
    const [notify, setNotify] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "chatPage.useEffect": ()=>{
            const name = localStorage.getItem('name');
            if (!name) return;
            const ws = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$chat$2f$globalSocket$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWebSocket"])();
            setsocket(ws);
            ws.onmessage = ({
        ...
        "chatPage.useEffect": ()=>{
            const fetchData = {
                "chatPage.useEffect.fetchData": async ()=>{
                    try {
                        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('http://localhost:4444/');
                        setFriend(res.data);
                    } catch (err) {
                        console.log(err);
                    }
...
_s(chatPage, "J7wJnsK8U0QF2msUhy5paL8oe/c=");
var _c, _c1;
...
//# sourceMappingURL=src_app_chat_e7506003._.js.map