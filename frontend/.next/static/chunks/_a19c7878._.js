...
;
;
const useUserStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])(console.log("Initializing user store"), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$middleware$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persist"])((set)=>({
        user: null,
        setUser: (userObj)=>set({
                user: userObj
            }),
...
const ProfileSettingsPage = ()=>{
    _s();
    const Userdata = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$userStore$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUserStore"])({
        "ProfileSettingsPage.useUserStore[Userdata]": (state)=>state.user
    }["ProfileSettingsPage.useUserStore[Userdata]"]);
    ...
    const handleImageChange = (e)=>{
        ...
        if (file) {
            if (file.size > 5 * 1024 * 1024) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Image size should be less than 5MB');
                return;
            }
    ...
    const validateForm = ()=>{
        ...
        if (isPasswordAuth && (formData.newPassword || formData.confirmPassword)) {
            if (formData.newPassword.length < 8) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Password must be at least 8 characters long');
                return false;
            }
    ...
    const handleSave = async ()=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Failed to update profile. Please try again.');
        } finally{
            setIsLoading(false);
        }
    };
...
_s(ProfileSettingsPage, "jrs5CsNKSdbfvaJUJRsy7y9Nkpc=", false, function() {
    return [
...
//# sourceMappingURL=_a19c7878._.js.map