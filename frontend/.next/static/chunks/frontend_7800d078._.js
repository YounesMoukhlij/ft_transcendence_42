...
"[project]/frontend/src/app/(auth)/forgotPassword/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/node_modules/axios/lib/axios.js [app-client] (ecmascript)"); // Import axios
;
...
const ForgotPasswordPage = ()=>{
    ...
    alert("ddsda");
    console.log("fsafaf");
    const [currentStep, setCurrentStep] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(STEPS.ENTER_EMAIL);
    ...
    const [resetToken, setResetToken] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const handleSendCode = async (e)=>{
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("".concat(("TURBOPACK compile-time value", "http://e1r8p8.1337.ma:4444"), "/forgotPassword"), {
                email
            });
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(data.message);
            setCurrentStep(STEPS.VERIFY_CODE);
        } catch (err) {
            var _err_response_data, _err_response;
            // Axios error handling: check if response data exists
            const errorMessage = ((_err_response = err.response) === null || _err_response === void 0 ? void 0 : (_err_response_data = _err_response.data) === null || _err_response_data === void 0 ? void 0 : _err_response_data.message) || err.message || 'An error occurred. Please try again.';
    ...
    const handleVerifyCode = async (e)=>{
        ...
        setError(null);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("".concat(("TURBOPACK compile-time value", "http://e1r8p8.1337.ma:4444"), "/verifyCode"), {
                email,
                code
            });
            const data = response.data;
    ...
    const handleResetPassword = async (e)=>{
        ...
        setError(null);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("".concat(("TURBOPACK compile-time value", "http://e1r8p8.1337.ma:4444"), "/resetPasswordWithToken"), {
                resetToken,
                newPassword
            });
            const data = response.data;
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Password has been reset successfully!');
...
_s(ForgotPasswordPage, "pIU45dcjYNyqrjdo0CjWZtavy5k=", false, function() {
    return [
...
//# sourceMappingURL=frontend_7800d078._.js.map