...
const ProfileSettingsPage = ()=>{
    ...
    const handleSaveProfile = async ()=>{
        ...
        try {
            ...
            if (data.code === 409) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(data.message || 'Username or email already taken');
                setIsLoading(false);
                return;
            }
    ...
    const handleSaveSecurity = async ()=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Failed to update security settings');
        } finally{
            setIsLoading(false);
        }
    };
...
_s(ProfileSettingsPage, "Rr54C4SlQpiAuhsmEiF/7szcDIc=", false, function() {
    return [
...
//# sourceMappingURL=_33916db7._.js.map