...
const LeaderBord = ({ users })=>{
    async function handleAddFriend(username) {
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('http://localhost:4444/sendRequestFriend', {
                sender,
                friend: username,
        ...
        "SettingsPage.useEffect": ()=>{
            const fetchData = {
                "SettingsPage.useEffect.fetchData": async ()=>{
                    try {
                        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('http://localhost:4444/Xprank', {
                            params: {
                                user: username
                            }
                        });
