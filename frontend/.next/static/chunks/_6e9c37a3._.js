...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cookies$2d$next$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/cookies-next/lib/index.js [app-client] (ecmascript)"); // Correct import for Client Components
;
...
const ForgotPasswordPage = ()=>{
    ...
    const userAuthToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cookies$2d$next$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCookie"])('auth_token');
    ...
    const handleSendCode = async (e)=>{
        ...
        setLoading(true);
        setError(null);
        // Set headers dynamically, using the token read from the cookie
        const headers = {
            'Content-Type': 'application/json'
        };
        // --- FIX 2: Check if token exists and pass it in the header ---
        if (userAuthToken) {
    ...
    const handleVerifyCode = async (e)=>{
        ...
        setLoading(true);
        setError(null);
        // FIX NOTE: No Authorization token needed for verification (usually)
        try {
...
_s(ForgotPasswordPage, "FYqwnRJVLqnYuN7bAkciEje679s=", false, function() {
    return [
...
//# sourceMappingURL=_6e9c37a3._.js.map