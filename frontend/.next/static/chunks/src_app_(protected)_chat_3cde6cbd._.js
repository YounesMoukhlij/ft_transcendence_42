...
async function fetchData(friend_id, title, setDboubleBlock, Setuser_block) {
    ...
    try {
        const convRes = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`http://${("TURBOPACK compile-time value", "localhost")}:${("TURBOPACK compile-time value", "4444")}/getConversationId`, {
            friend_id: friend_id
        }, {
            headers: {
        ...
        const msgsRes = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`http://${("TURBOPACK compile-time value", "localhost")}:${("TURBOPACK compile-time value", "4444")}/getMsgs`, {
...
//# sourceMappingURL=src_app_%28protected%29_chat_3cde6cbd._.js.map