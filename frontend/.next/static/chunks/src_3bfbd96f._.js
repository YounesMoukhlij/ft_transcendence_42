...
api.interceptors.request.use((config)=>{
    const token = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$userStore$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUserStore"].getState().user?.access_token;
    if (token) {
...
api.interceptors.response.use((response)=>{
    ...
    if (error.response.status === 401 && !originalRequest._retry) {
        ...
        try {
            const refreshToken = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$userStore$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUserStore"].getState().getRefreshToken();
            ...
            if (!refreshToken) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$userStore$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUserStore"].getState().clearUser();
                window.location.href = '/signIn';
                return Promise.reject(error);
            }
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${API_URL}/refreshToken`, {
                refreshToken
            });
            const { user, setUser } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$userStore$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUserStore"].getState();
            const updatedUser = {
                ...user,
...
const ProfileSettingsPage = ()=>{
    ...
    const handleSaveProfile = async ()=>{
        ...
        try {
            ...
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/updateUserInfo', {
    ...
    const handleSaveSecurity = async ()=>{
        ...
        try {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/updateUserPassword', {
...
_s(ProfileSettingsPage, "IhuwJXXFqrXmKl4C1WNhgY1F3/A=", false, function() {
    return [
...
//# sourceMappingURL=src_3bfbd96f._.js.map