                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            gameState.mode === 'ai' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$icons$2f$fa$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FaRobot"], {
                                ...
                                lineNumber: 516,
                                columnNumber: 13
                            }, ("TURBOPACK compile-time value", void 0)) : gameState.players && ((_gameState_players_3 = gameState.players[1]) === null || _gameState_players_3 === void 0 ? void 0 : _gameState_players_3.avatar) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
...
"[project]/src/app/(protected)/game/remote/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function RemoteGamePage() {
    ...
    const { gameState, setGameRoom, setPlayers, setCustomisation, setIsHost, setGameMode } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$GameContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameContext"])();
    // Component state
    const [gameStatus, setGameStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('menu');
    ...
    const [showFriendsDropdown, setShowFriendsDropdown] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const sendInvitationToFriend = (friend)=>{
        ...
        console.log("Invitation sent to ".concat(friend.name));
    };
    // Set page title and game mode
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RemoteGamePage.useEffect": ()=>{
            document.title = 'Online Multiplayer Ping Pong';
            setGameMode('remote'); // Ensure remote mode is set
        }
    }["RemoteGamePage.useEffect"], []); // Empty dependency array - only run once on mount
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RemoteGamePage.useEffect": ()=>{
            ...
            const username = globalStore.getState().username || '';
            const sendUsername = {
                "RemoteGamePage.useEffect.sendUsername": ()=>{
            ...
            const handleGameMessage = {
                "RemoteGamePage.useEffect.handleGameMessage": (message)=>{
                        ...
                        case 'roomCreated':
                            ...
                            if (friendToInviteStr) {
                                try {
                                    ...
                                    setTimeout({
                                        "RemoteGamePage.useEffect.handleGameMessage": ()=>{
                                            const roomCode = message.data.roomId;
                                            const inviteLink = "".concat(window.location.origin, "/game/remote?room=").concat(roomCode);
                                            const inviteMessage = "Hey ".concat(friendToInvite.name, "! Come play Ping Pong with me! Join my game room: ").concat(roomCode, "\n\nClick here to join: ").concat(inviteLink);
                                            if (navigator.share) {
                                                navigator.share({
                                                    title: "Ping Pong Game Invitation",
                                                    text: "Join my Ping Pong game! Room: ".concat(roomCode),
                                                    url: inviteLink
                                                }).catch({
                                                    "RemoteGamePage.useEffect.handleGameMessage": ()=>{
                                                        navigator.clipboard.writeText(inviteMessage).then({
                                                            "RemoteGamePage.useEffect.handleGameMessage": ()=>{
                                                                alert("Room created! Invitation copied to clipboard for ".concat(friendToInvite.name, "."));
                                                            }
                                                        }["RemoteGamePage.useEffect.handleGameMessage"]);
                                                    }
                                                }["RemoteGamePage.useEffect.handleGameMessage"]);
                                    ...
                                    }["RemoteGamePage.useEffect.handleGameMessage"], 500); // Small delay to ensure UI is updated
                                } catch (e) {
                            ...
                            break;
                        case 'roomJoined':
                            var _message_data_gameState_players_find;
                            setGameRoom({
                                id: message.data.roomId,
                                status: 'waiting',
                                playerId: (_message_data_gameState_players_find = message.data.gameState.players.find({
                                    "RemoteGamePage.useEffect.handleGameMessage": (p)=>{
                                        var _gameState_gameRoom;
                                        return p.id !== ((_gameState_gameRoom = gameState.gameRoom) === null || _gameState_gameRoom === void 0 ? void 0 : _gameState_gameRoom.playerId);
                                    }
                                }["RemoteGamePage.useEffect.handleGameMessage"])) === null || _message_data_gameState_players_find === void 0 ? void 0 : _message_data_gameState_players_find.id
                            });
                            setPlayers(message.data.gameState.players);
                            setGameStatus('waiting');
                            setError('');
            ...
            const handleMessage = {
                "RemoteGamePage.useEffect.handleMessage": (event)=>{
                    try {
            ...
            }["RemoteGamePage.useEffect.handleMessage"];
    ...
    }["RemoteGamePage.useEffect"], []); // Keep empty dependency array since we want this to run only once
    const leaveRoom = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RemoteGamePage.useEffect": ()=>{
            const handleClickOutside = {
                "RemoteGamePage.useEffect.handleClickOutside": (event)=>{
                    if (dropdownRef.current && !dropdownRef.current.contains(event.target)) {
                        setShowFriendsDropdown(false);
                    }
                }
            }["RemoteGamePage.useEffect.handleClickOutside"];
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: [
                                "Room: ",
                                (_gameState_gameRoom = gameState.gameRoom) === null || _gameState_gameRoom === void 0 ? void 0 : _gameState_gameRoom.id
                            ]
                        }, void 0, true, {
                            fileName: "[project]/src/app/(protected)/game/remote/page.tsx",
                            lineNumber: 316,
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    gameState.isHost && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        onClick: findMatch,
                                        className: "w-full px-6 py-3 bg-yellow-500 text-white rounded-lg hover:bg-yellow-600 transition-colors font-semibold ".concat(isSearching ? 'opacity-60 cursor-not-allowed' : ''),
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            gameState.players.map((player, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        children: [
                                            ...
                                            "Invite Friends",
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "ml-2 transform transition-transform ".concat(showFriendsDropdown ? 'rotate-180' : ''),
                                                children: "▼"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/(protected)/game/remote/page.tsx",
                                                lineNumber: 467,
                                    ...
                                    showFriendsDropdown && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                                    ...
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                            ...
                                                                            children: [
                                                                                ...
                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                    className: "absolute -bottom-1 -right-1 w-2.5 h-2.5 rounded-full border border-gray-700 ".concat(friend.isOnline ? 'bg-green-500' : 'bg-gray-500')
                                                                                }, void 0, false, {
                                                                                    fileName: "[project]/src/app/(protected)/game/remote/page.tsx",
                                                                                    lineNumber: 495,
                                                                                    columnNumber: 29
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                            children: [
                                                                                ...
                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                                    className: "text-xs ".concat(friend.isOnline ? 'text-green-400' : 'text-gray-400'),
                                                    ...
                                                    friendsList.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(RemoteGamePage, "LFSZfjl8PbbYM9vkk1exWATPrwg=", false, function() {
    return [
...
_c = RemoteGamePage;
var _c;
__turbopack_context__.k.register(_c, "RemoteGamePage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_f31adf6f._.js.map