...
"[project]/src/app/chat/globalSocket.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function getWebSocket() {
    if (!s) s = new WebSocket('ws://localhost:4444/ws');
    s.onclose = ()=>{
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$chat$2f$globalSocket$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/chat/globalSocket.tsx [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function chatPage() {
    ...
    const [notify, setNotify] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const name = localStorage.getItem('name');
        if (!name) return;
        const ws = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$chat$2f$globalSocket$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getWebSocket"])();
        setsocket(ws);
        ws.onmessage = (event)=>{
            const { type, data } = JSON.parse(event.data);
            if (type == "message") setMessages((prev)=>[
                    ...prev,
                    {
                        sender: "name",
                        message: data
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchData = async ()=>{
            try {
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('http://localhost:4444/');
                setFriend(res.data);
            } catch (err) {
                console.log(err);
            }
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                messages.map((item, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__de2f9cdb._.js.map