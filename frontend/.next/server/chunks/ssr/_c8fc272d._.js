...
const ProfileSettingsPage = ()=>{
    ...
    const Userdata = {
        id_user: 1,
        username: 'yzoullik',
        full_name: 'Youssef Zoullik',
        email: 'yzoullik@example.com',
        profile_img: defaultProfileImg,
        bio: 'Just a developer trying to make it in the world.',
        auth_method: 0,
        languages: 'en'
    };
    const languages = [
        ...
        try {
            ...
            const response = await fetch(`${API_URL}/updateUserInfo`, {
                ...
                body: JSON.stringify({
                    ...
                    profile_img: previewImage || Userdata.profile_img,
            ...
            if (data.code === 409) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(data.message || 'Username or email already taken');
                setIsLoading(false);
                return;
            }
            ...
            setUser((prev)=>({
                    ...prev,
                    profile_img: previewImage || prev.profile_img,
                    languages: formData.languages,
                    username: formData.username,
                    full_name: formData.full_name,
                    email: formData.email,
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Failed to update profile');
        } finally{
            setIsLoading(false);
        }
    };
    const handleSaveSecurity = async ()=>{
        ...
        try {
            //  parsing inputs
            if (!formData.currentPassword.trim() || formData.currentPassword.trim() === '' || formData.currentPassword.length < 8) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Failed to update security settings');
        } finally{
            setIsLoading(false);
        }
    };
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                    src: previewImage || Userdata.profile_img,
                                                    alt: "Profile",
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        className: `px-6 py-3 rounded-xl font-semibold text-sm transition ${isLoading || !isPasswordAuth ? 'bg-gray-600 cursor-not-allowed opacity-50' : 'bg-white text-black hover:bg-gray-500 hover:text-white active:scale-95 hover:cursor-pointer'}`,
...
//# sourceMappingURL=_c8fc272d._.js.map