...
const globalStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        ...
        connect: ()=>{
            ...
            const ws = new WebSocket(`ws://${("TURBOPACK compile-time value", "10.13.7.1")}:${("TURBOPACK compile-time value", "4444")}/ws`);
            ws.onopen = ()=>{
...
function Navbar() {
    ...
    async function DelteFriendRequest(notify_id) {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`http://${("TURBOPACK compile-time value", "10.13.7.1")}:${("TURBOPACK compile-time value", "4444")}/DeleteFriendRequest`, {
            notify_id
        });
    }
    async function AcceptFriendRequest(username) {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`http://${("TURBOPACK compile-time value", "10.13.7.1")}:${("TURBOPACK compile-time value", "4444")}/AddFriend`, {
            user1: username,
            user2: loginUsername
        });
    }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function get_notify() {
            ...
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`http://${("TURBOPACK compile-time value", "10.13.7.1")}:${("TURBOPACK compile-time value", "4444")}/GetNotification`, {
                params: {
                    user
                }
            });
