...
function Navbar() {
    ...
    async function DelteFriendRequest(notify_id) {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`http://${("TURBOPACK compile-time value", "10.11.9.7")}:${("TURBOPACK compile-time value", "4444")}/DeleteFriendRequest`, {
            params: {
                id: notify_id
            },
            headers: {
    ...
    async function AcceptFriendRequest(item) {
        ...
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`http://${("TURBOPACK compile-time value", "10.11.9.7")}:${("TURBOPACK compile-time value", "4444")}/AddFriend`, {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        async function get_notify() {
            try {
                const result = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`http://${("TURBOPACK compile-time value", "10.11.9.7")}:${("TURBOPACK compile-time value", "4444")}/GetNotification`, {
                    headers: {
                        Authorization: `Bearer ${user.access_token}`
                    }
                });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eed18586._.js.map