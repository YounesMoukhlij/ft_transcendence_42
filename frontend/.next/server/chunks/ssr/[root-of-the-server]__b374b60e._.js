...
const ProfileSettingsPage = ()=>{
    // 🎯 FIX: Select user (state) and setUser (action) separately to ensure stable references.
    ...
    const handleSaveProfile = async ()=>{
        ...
        try {
            ...
            // Update user store by creating a new merged object and calling setUser
            const updatedUser = {
                ...user,
                profile_img: imageToSave,
                languages: formData.languages,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b374b60e._.js.map