...
api.interceptors.request.use((config)=>{
    const token = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$userStore$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useUserStore"].getState().user?.access_token;
    if (token) {
...
api.interceptors.response.use((response)=>{
    ...
    if (error.response.status === 401 && !originalRequest._retry) {
        ...
        try {
            const refreshToken = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$userStore$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useUserStore"].getState().getRefreshToken();
            ...
            if (!refreshToken) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$userStore$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useUserStore"].getState().clearUser();
                window.location.href = '/signIn';
                return Promise.reject(error);
            }
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${API_URL}/refreshToken`, {
                refreshToken
            });
            const { user, setUser } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$userStore$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useUserStore"].getState();
            const updatedUser = {
                ...user,
...
const ProfileSettingsPage = ()=>{
    ...
    const handleSaveProfile = async ()=>{
        ...
        try {
            ...
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/updateUserInfo', {
    ...
    const handleSaveSecurity = async ()=>{
        ...
        try {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/updateUserPassword', {
                current_password: formData.currentPassword,
                new_password: formData.newPassword
            });
            if (!data.success) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(data.message || 'Failed to update security settings');
                return;
            }
    ...
    const handleToggle2FA = async ()=>{
        ...
        try {
            ...
            if (!response.ok || !data.success) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(data.message || 'Failed to update 2FA settings');
                return;
            }
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(`Two-Factor Authentication ${!is2FAEnabled ? 'enabled' : 'disabled'} successfully!`);
        // set a timeout to clear the message after 3 seconds
        } catch (error) {
            console.error('2FA update error:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('An unexpected error occurred while updating 2FA settings');
        } finally{
            setIsLoading(false);
        }
    };
...
//# sourceMappingURL=src_bacf06fe._.js.map