...
async function fetchData(friend_id, title, setDboubleBlock, Setuser_block) {
    const { user, updateLastMessage } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$userStore$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useUserStore"].getState();
    localStorage.setItem('room_select', title);
    localStorage.setItem('friend_id', friend_id);
    try {
        const convRes = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`http://${("TURBOPACK compile-time value", "10.11.9.7")}:${("TURBOPACK compile-time value", "4444")}/getConversationId`, {
            friend_id: friend_id
        }, {
            headers: {
        ...
        const msgsRes = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`http://${("TURBOPACK compile-time value", "10.11.9.7")}:${("TURBOPACK compile-time value", "4444")}/getMsgs`, {
...
function ChatPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchData = async ()=>{
            try {
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`http://${("TURBOPACK compile-time value", "10.11.9.7")}:${("TURBOPACK compile-time value", "4444")}/GetFriends`, {
                    params: {
    ...
    async function handleBlock(friend, setDboubleBlock, double_block, Setuser_block, user_block) {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`http://${("TURBOPACK compile-time value", "10.11.9.7")}:${("TURBOPACK compile-time value", "4444")}/block`, {
            user: user.username,
            conv_id: id,
            friend: friend,
            friend_id: friend_id
    ...
    async function Deblock(friend, setDboubleBlock, double_block, Setuser_block, user_block) {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`http://${("TURBOPACK compile-time value", "10.11.9.7")}:${("TURBOPACK compile-time value", "4444")}/Deblock`, {
            user: user.username,
            conv_id: id,
            friend: friend,
            friend_id: friend_id
    ...
    async function handleUnfriend(friend, removeFriend) {
        ...
        SetSelectContact(false);
        const friend_id = localStorage.getItem("friend_id");
        await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`http://${("TURBOPACK compile-time value", "10.11.9.7")}:${("TURBOPACK compile-time value", "4444")}/unfriend`, {
            user: user.username,
            conv_id: id,
            friend: friend,
            friend_id: friend_id
    ...
    const handleSend = async ()=>{
        ...
        const id = localStorage.getItem('conversationId');
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`http://${("TURBOPACK compile-time value", "10.11.9.7")}:${("TURBOPACK compile-time value", "4444")}/IsOnline`, {
                params: {
                    username: friend
                }
            });
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`http://${("TURBOPACK compile-time value", "10.11.9.7")}:${("TURBOPACK compile-time value", "4444")}/sendMsg`, {
                user: user.username,
                input,
                id,
                friend,
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: double_block === 1 && user_block === user.username || double_block === 2 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
//# sourceMappingURL=src_app_%28protected%29_chat_a70cc17d._.js.map